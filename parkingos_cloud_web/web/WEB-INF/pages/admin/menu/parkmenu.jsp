...
function createIframe(oDiv,id,url){
	...
	if(iframe == undefined){
		...
		oFrame.style.height	="100%";// gwh() - 67 + "px";//document.documentElement.scrollHeight - 30 +"px";
		/*if(isIE()&&isIE()<11) {
...
<div style="width:100%;float:left;height:58px;left:0px;top:0px;background-image:url('images/page_top_bg.png');position: absolute;overflow:hidden;">
   <div style='width:200px;margin-left:19px;margin-top:10px;float:left;'><img style="width:157px;height:40px;" src='${logourl}'/></div>
    <div id="page-tabs">
