...
var _faultT = new TQTable({
	...
	//searchitem:true,
	param:"action=querydetail&sensorid="+id+"&btime="+btime+"&etime="+etime,
	tableObj:T("#faultobj"),
	fit:[true,true,true],
				...
				TSform ({
					...
					function(callback,formName){
						_faultT.C({
							cpage:1,
							tabletitle:"高级搜索结果",
							extparam:"&action=querydetail&sensorid="+id+"&btime="+btime+"&etime="+etime+"&"+Serializ(formName)
						})
					}
				});	
			}
