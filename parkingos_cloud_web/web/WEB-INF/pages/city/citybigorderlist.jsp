...
var _mediaField = [
		...
		{fieldcnname:"所属集团",fieldname:"groupid",fieldvalue:'',inputtype:"cselect",noList:groups,target:"comid",action:"getparks",twidth:"100" ,height:"",issort:false,shide:ishiddlegroup,fhide:ishiddlegroup},
		{fieldcnname:"车场名称",fieldname:"comid",fieldvalue:'',inputtype:"cselect",noList:parks,twidth:"150",target:"in_passid,berthsec_id",action:"getcompass,getberthseg",twidth:"100" ,height:"",issort:false},
		...
		{fieldcnname:"进场收费员账号",fieldname:"uid",fieldvalue:'',inputtype:"text",twidth:"100" ,height:"",issort:false},
		{fieldcnname:"进场收费员名称",fieldname:"collector",fieldvalue:'',inputtype:"text",twidth:"100" ,height:"",issort:false,shide:true},
		{fieldcnname:"车场类型",fieldname:"parking_type",fieldvalue:'',inputtype:"select",noList:[{"value_no":-1,"value_name":"全部"},{"value_no":0,"value_name":"地面"},{"value_no":1,"value_name":"地下"},{"value_no":2,"value_name":"占道"}] ,twidth:"100" ,height:"",issort:true},
		{fieldcnname:"进场方式",fieldname:"c_type",fieldvalue:'',inputtype:"select",noList:[{"value_no":-1,"value_name":"全部"},{"value_no":0,"value_name":"NFC刷卡"},{"value_no":1,"value_name":"Ibeacon"},{"value_no":2,"value_name":"手机扫牌"},{"value_no":3,"value_name":"通道扫牌"},{"value_no":4,"value_name":"直付"},{"value_no":5,"value_name":"月卡"},{"value_no":6,"value_name":"车位二维码"},{"value_no":7,"value_name":"月卡第二辆车"}] ,twidth:"100" ,height:"",issort:true},
		...
		{fieldcnname:"时长",fieldname:"duration",fieldvalue:'',inputtype:"text", twidth:"140" ,height:"",issort:false,shide:true},
		{fieldcnname:"状态",fieldname:"state",fieldvalue:'',inputtype:"select",noList:[{"value_no":-1,"value_name":"全部"},{"value_no":0,"value_name":"未支付"},{"value_no":1,"value_name":"已支付"},{"value_no":2,"value_name":"逃单"}] ,twidth:"100" ,height:"",issort:true,shide:true},
...
var _orderT = new TQTable({
	tabletitle:"大额订单<font style='font-size:14px;'>（停车时长在2到10天内的未结算订单）</font>",
	ischeck:false,
...
function coutomsearch(){
	var html = "&nbsp;&nbsp;&nbsp;&nbsp;所属集团：&nbsp;&nbsp;<select style='width:130px' id='groups'></select>&nbsp;&nbsp;<input type='button' onclick='searchdata();' value=' 查 询 '/>";
	if(!ishiddlegroup)
		return html;
	else 
		return '';
