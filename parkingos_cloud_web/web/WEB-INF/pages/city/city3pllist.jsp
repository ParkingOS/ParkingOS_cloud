...
var sources = [{"value_no":-1,"value_name":"全部"},{"value_no":1,"value_name":"支付宝服务费"},{"value_no":2,"value_name":"微信服务费"},{"value_no":6,"value_name":"微信充值"},{"value_no":7,"value_name":"支付宝充值"},{"value_no":8,"value_name":"提现"}];
var _mediaField = [
		...
		{fieldcnname:"来源/去向",fieldname:"utype",fieldvalue:'',inputtype:"select", noList:sources ,twidth:"100" ,height:"",issort:false},
		{fieldcnname:"第三方订单号",fieldname:"online_orderid",fieldvalue:'',inputtype:"text", twidth:"150" ,height:"",issort:false},
		...
		{fieldcnname:"操作人账号",fieldname:"uin",fieldvalue:'',inputtype:"number", twidth:"100" ,height:"",issort:false,
			process:function(value,pid){
								if(value == "-1"){
									return "";
								}else{
