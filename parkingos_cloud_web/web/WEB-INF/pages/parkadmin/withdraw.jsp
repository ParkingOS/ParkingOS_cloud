...
var _mediaField = [
		...
		{fieldcnname:"类型",fieldname:"wtype",fieldvalue:'',inputtype:"select",noList:[{"value_no":1,"value_name":"个人提现"},{"value_no":0,"value_name":"公司提现"},{"value_no":2,"value_name":"对公提现"}], twidth:"140" ,height:"",hide:true},
		...
		{fieldcnname:"状态",fieldname:"state",fieldvalue:'',inputtype:"select",noList:[{"value_no":0,"value_name":"等待处理"},{"value_no":2,"value_name":"处理中"},{"value_no":3,"value_name":"已支付"}], twidth:"140" ,height:"",issort:false}
	];
var _withdrawT = new TQTable({
	tabletitle:"提现管理     账户余额："+maxmoney,
	ischeck:false,
