...
<script src="js/tq.public.js?435455deed3ee" type="text/javascript">//表格</script>
...
var _addField = [
		...
		{fieldcnname:"包月产品",fieldname:"p_name",fieldvalue:'',inputtype:"cselect",noList:pnames,target:"total,act_total",params:["months","p_name"],action:"getprodsum",twidth:"180" ,height:"",issort:false},
		{fieldcnname:"起始时间",fieldname:"b_time",fieldvalue:'${btime}',inputtype:"sdate",twidth:"150" ,height:"",issort:false},
		{fieldcnname:"购买月数",fieldname:"months",fieldvalue:'',inputtype:"cselect",noList:month_select,target:"total,act_total",params:["months","p_name"],action:"getprodsum", twidth:"150" ,height:"",issort:false},
		...
		{fieldcnname:"联系电话",fieldname:"mobile",fieldvalue:'',inputtype:"text", twidth:"150" ,height:"",issort:false},
		//{fieldcnname:"车型类型",fieldname:"car_type_id",fieldvalue:'0',inputtype:"select",noList:carTypes, twidth:"150" ,height:"",issort:false},
		{fieldcnname:"单双日限行",fieldname:"limit_day_type",fieldvalue:'',inputtype:"select",noList:[{"value_no":0,"value_name":"不限制"},{"value_no":1,"value_name":"限制"}], twidth:"150" ,height:"",issort:false},
...
var _editField = [
				...
				//{fieldcnname:"车牌号码",fieldname:"car_number",fieldvalue:'',inputtype:"text", twidth:"200" ,height:"",issort:false},
         		{fieldcnname:"包月产品",fieldname:"p_name",fieldvalue:'',inputtype:"cselect",noList:pnames,target:"total",params:["months","p_name"],action:"getprodsum",twidth:"150" ,height:"",issort:false,edit:false},
...
var _renewField = [
				...
				//{fieldcnname:"地址(选填)",fieldname:"address",fieldvalue:'',inputtype:"text", twidth:"180" ,height:"",issort:false,edit:false,fhide:true,shide:true},
         		{fieldcnname:"包月产品",fieldname:"p_name",fieldvalue:'',inputtype:"cselect",noList:pnames,target:"total",params:["months","p_name"],action:"getprodsum",twidth:"180" ,height:"",issort:false,edit:false},
         		{fieldcnname:"起始时间",fieldname:"b_time",fieldvalue:'',inputtype:"sdate",twidth:"150" ,height:"",issort:false,edit:false},
         		{fieldcnname:"续费月数",fieldname:"months",fieldvalue:'',inputtype:"cselect",noList:month_select,target:"total,act_total",params:["months","p_name"],action:"getprodsum", twidth:"150" ,height:"",issort:false},
         		{fieldcnname:"应收金额",fieldname:"total",fieldvalue:'',inputtype:"text", twidth:"150" ,height:"",issort:false,edit:true},
...
var rules =[{name:"b_time",type:"",url:"",requir:true,warn:"请选择时间",okmsg:""},
            ...
            {name:"p_name",type:"",url:"",requir:true,warn:"请选择月卡套餐",okmsg:""}];
