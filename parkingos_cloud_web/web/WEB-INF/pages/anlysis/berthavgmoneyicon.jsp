...
<div class="search">
        <div class="qiehua">
        <a  href="berthavgmoney.do"  id="table">列表</a>
        <a href="" id="icon" >图表</a>
        </div>
...
<!-- 为ECharts准备一个具备大小（宽高）的Dom --><script type="text/javascript" >
...
function initCharData(operate) {
	...
	ylist = [];
	  ...
	  if(operate==''){
	      ...
	      data_info=eval(T.A.sendData("berthavgmoney.do?action=echarts&operate=1&btime="+btime));
	  }
      ...
      for(var i=0;i<data_info.length;i++)
      {
        ylist.push(data_info[i].avgmoney);
      }
}
