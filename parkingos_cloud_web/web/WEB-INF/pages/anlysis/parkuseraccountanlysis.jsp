...
var btime="${btime}"
var etime="${etime}";
var type =[["-1","请选择"],["0","充值"],["1","提现"]];
var targets =[["-1","请选择"],["0","银行卡"],["1","支付宝"],["2","微信"],["3","停车宝"],["4","车主"]];
...
var _mediaField = [
		...
		{fieldcnname:"收费员",fieldname:"uin",inputtype:"number", twidth:"100",issort:false},
		...
		{fieldcnname:"来源/去向",fieldname:"target",inputtype:"select",noList:setSelects(targets), twidth:"100",issort:false},
