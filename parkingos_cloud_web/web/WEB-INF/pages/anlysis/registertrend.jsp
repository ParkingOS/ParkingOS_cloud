...
<script type="text/javascript" src="js/anlysis/registeranlysis.js"></script>
...
<!--顶部开始-->
<div class="top">
<ul class="title"><li class="parentmenu">会员注册趋势分析 </li>
</ul>
<ul class="search">
...
-<input  class="Wdate" onclick="WdatePicker({dateFmt:'yyyy-MM-dd',startDate:'%y-%M-01',alwaysUseStartDate:true})" type="text" name="endDateSelect" id="etime" value="${etime}" align="absmiddle" readonly   />
</span>
