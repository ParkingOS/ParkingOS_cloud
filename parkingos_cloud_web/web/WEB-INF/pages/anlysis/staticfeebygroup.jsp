...
var _mediaField =[
	{kindname:"",kinditemts: [
          {fieldcnname:"编号",fieldname:"id",inputtype:"number",twidth:"80",issort:false }
       ]},
		{kindname:"",kinditemts: [
  ...
  var _exportField = [
		{fieldcnname:"运营集团名称",fieldname:"name",inputtype:"text",twidth:"150",issort:false }
		];
var back = "";
if("${from}" == "index"){
