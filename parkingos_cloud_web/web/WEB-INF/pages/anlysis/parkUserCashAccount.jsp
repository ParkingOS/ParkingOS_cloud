...
var charge_type = [{"value_no":-1,"value_name":"全部"},{"value_no":0,"value_name":"停车费"},
            {"value_no":1,"value_name":"预付停车费"},{"value_no":2,"value_name":"预付超额退款"},
            {"value_no":3,"value_name":"预付不足补缴"},{"value_no":4,"value_name":"追缴停车费"}];

var _mediaField = [
		{fieldcnname:"编号",fieldname:"id",fieldvalue:'',inputtype:"text",twidth:"80" ,height:"",edit:false,issort:false,shide:true,fhide:true},
		{fieldcnname:"账号",fieldname:"uin",fieldvalue:'',inputtype:"number", twidth:"100" ,height:"",issort:false,shide:true},
		{fieldcnname:"账目类型",fieldname:"ctype",fieldvalue:'',inputtype:"select", noList:type ,twidth:"100" ,height:"",issort:false},
		{fieldcnname:"操作方式",fieldname:"target",fieldvalue:'',inputtype:"select", noList:charge_type,twidth:"100" ,height:"",issort:false},
