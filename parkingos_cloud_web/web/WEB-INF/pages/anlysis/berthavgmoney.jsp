...
<div class="search">
        ...
        <a href="berthavgmoney.do?action=echarts" id="icon"  >图表</a>
        </div>
...
<div id="berthavgmoneyobj" style="width:100%;height:100%;margin:0px;"></div>
...
var _mediaField = [
		...
		{fieldcnname:"总收入",fieldname:"total",inputtype:"number", twidth:"200",issort:false},
		{fieldcnname:"泊位数",fieldname:"parking_total",inputtype:"number", twidth:"200",issort:false},
		{fieldcnname:"泊位平均收入",fieldname:"avgmoney",inputtype:"number", twidth:"200",issort:false}
		];
var _anlysisT = new TQTable({
	tabletitle:"泊位平均收入",
	ischeck:false,
	tablename:"berthavgmoney_tables",
	dataUrl:"berthavgmoney.do",
	iscookcol:false,
	buttons:false,
	quikcsearch:coutomsearch(),
	param:"action=query",
	tableObj:T("#berthavgmoneyobj"),
	fit:[true,true,true],
