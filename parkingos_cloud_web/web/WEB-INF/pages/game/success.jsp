...
<body id='body'>
	<div id="sale" style="position:absolute;">
		<img id='saleimg' src='images/game/sale.png'  id='ruleimg'/>
	</div>
	...
	<div id="share" style="position:absolute;" onclick='viewsort();'>
		<img id='shareimg' src='images/game/viewsort.png' width='140px' />
	</div>
</body>
<script>
var type='${ctype}';
var words = "恭喜，挑战成功，折扣券数量翻倍";
if(type&&type<2){
	document.getElementById("saleimg").src='images/game/ticket.png';
	words = "恭喜，挑战成功，停车券金额翻倍";
}
