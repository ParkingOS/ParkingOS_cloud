...
function getAuthButtons(){
	...
	bts.push({dname:"添加巡查员",icon:"edit_add.png",onpress:function(Obj){
			...
			Content:"<iframe src=\"workgroupmanage.do?action=saveinspector&work_group_id="+work_group_id+"\" style=\"width:100%;height:100%\" frameborder=\"0\"></iframe>",
			Width:T.gww()-100,
			Height:T.gwh()-50
		})
	}});
...
function getAuthIsoperateButtons(){
	...
	bts.push({name:"删除",fun:function(id){
		...
		T.A.sendData("workgroupmanage.do?action=deleteinspector","post","id="+id,
