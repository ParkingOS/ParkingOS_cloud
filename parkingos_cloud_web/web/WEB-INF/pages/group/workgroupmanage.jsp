...
var _mediaField = [
		...
		{fieldcnname:"收费组名称",fieldname:"workgroup_name",fieldvalue:'',inputtype:"text",twidth:"100" ,height:"",issort:false},
...
function getAuthButtons(){
	var bts=[];
	if(subauth[1])
	bts.push({dname:"添加收费组",icon:"edit_add.png",onpress:function(Obj){
				T.each(_workgroupmanageT.tc.tableitems,function(o,j){
					o.fieldvalue = "";
				});
				Twin({Id:"workgroupmanage_add",Title:"添加收费组",Width:550,sysfun:function(tObj){
					Tform({
