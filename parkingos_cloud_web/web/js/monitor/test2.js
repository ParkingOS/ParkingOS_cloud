...
function ckstyle() { //定义总的风格
    var ck = {
		...
		*/
        ...
        setup: '1,1,1,1,1,2,0,1,0,3,0,1,200,0,2,1,0,1,1,1,1,10,3,0,1,2,3000,0,0,2,0,1,1,1,1,1,1,250,0,90,0,0,0',
        /*
...
(function() {
    var CKobject = {
		...
		embedSWF: function(C, D, N, W, H, V, P) {
			...
			//this._K_(D).addEventListener('dbclick', "alert(1)",false);
			//this._K_(D).click(function() {alert(1)} )
        },
