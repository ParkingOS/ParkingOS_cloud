var UITree=function(){
	var e=function(){
		$("#tree_1").jstree({
			...
			types:{"default":{icon:"fa fa-folder icon-state-warning icon-lg"},file:{icon:"fa fa-file icon-state-warning icon-lg"}},
			plugins:["types"]}),
				...
				core:{
					...
					data:[{
						...
						children:[{
							...
							{text:"initially open",icon:"fa fa-folder icon-state-default",state:{opened:!0},children:["Another node"]},
							{text:"custom icon",icon:"fa fa-warning icon-state-warning"},
							{text:"disabled node",icon:"fa fa-check icon-state-success",state:{disabled:!0}}
						]},
						...
						core:{
							...
							data:[
							      {text:"Parent Node",children:[
							                                    {text:"Initially selected",state:{selected:!0}},
							                                    {text:"Custom Icon",icon:"fa fa-warning icon-state-danger"},
							                                    {text:"Initially open",icon:"fa fa-folder icon-state-success",state:{opened:!0},children:[{text:"Another node",icon:"fa fa-file icon-state-warning"}]},
		...
		return{
			init:function(){
				...
				n(),
				a()}}}();
				App.isAngularJsApp()===!1&&jQuery(document).ready(function(){UITree.init()});