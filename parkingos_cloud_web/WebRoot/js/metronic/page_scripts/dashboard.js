var Dashboard = function() {
    ...
    return {
        ...
        initEasyPieCharts: function() {
            ...
            $('.easy-pie-chart .number.charging').easyPieChart({
                animate: 1000,
                size: 75,
                lineWidth: 3,
                barColor: App.getBrandColor('blue')
            });
            $('.easy-pie-chart .number.induce').easyPieChart({
                animate: 1000,
                size: 75,
                lineWidth: 3,
                barColor: App.getBrandColor('purple')
            });
            $('.easy-pie-chart .number.lock').easyPieChart({
                animate: 1000,
                size: 75,
                lineWidth: 3,
                barColor: App.getBrandColor('pink')
            });
