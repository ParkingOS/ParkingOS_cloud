...
<div class="header">
  <div class="logo"> <img style="width:157px;height:40px;" src='${logourl}'> </div>
  <div class="menu">
    <ul id="menues_list">
    </ul>
  </div>
...
function init(){
	...
	for(var i=0;i<menus.length;i++){
		...
		var innerHTML = '<div></div><a href="#" id="iframe-'+(i+1)+'" tid="'+aurl+'" onClick="switchTag(this,\''+aurl+'\')">'+menus[i].name+'</a>';
