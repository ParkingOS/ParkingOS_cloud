...
var _mediaField = [
		...
		{fieldcnname:"免费原因",fieldname:"freereasons",fieldvalue:'',inputtype:"select",noList:freereasons ,twidth:"80" ,height:""},
		...
		{fieldcnname:"状态",fieldname:"state",fieldvalue:'',inputtype:"select",noList:[{"value_no":-1,"value_name":"全部"},{"value_no":0,"value_name":"未支付"},{"value_no":1,"value_name":"已支付"},{"value_no":2,"value_name":"逃单"}] ,twidth:"100" ,height:"",issort:true},
...
var _searchField = [
		...
		{fieldcnname:"状态",fieldname:"state",fieldvalue:'',inputtype:"select",noList:[{"value_no":-1,"value_name":"全部"},{"value_no":0,"value_name":"未支付"},{"value_no":1,"value_name":"已支付"},{"value_no":2,"value_name":"逃单"}] ,twidth:"100" ,height:"",issort:false},
...
var _orderT = new TQTable({
	tabletitle:"订单管理(默认显示30天内的订单)&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;${parkinfo}",
	//ischeck:false,
