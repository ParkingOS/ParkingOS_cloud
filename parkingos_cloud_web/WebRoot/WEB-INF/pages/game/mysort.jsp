...
wx.hideMenuItems({
    menuList: ['menuItem:share:qq','menuItem:share:weiboApp','menuItem:favorite','menuItem:openWithQQBrowser','menuItem:copyUrl','menuItem:openWithSafari'] // 要隐藏的菜单项，只能隐藏“传播类”和“保护类”按钮，所有menu项见附录3
});
</script>
<script type="text/javascript">
var debuging = false;
...
var linkurl="";
var imgUrl = "";
var desc='我在${usercount}名车主中排第${sort}，获${tnum}个停车挑战名额，邀您挑战';
...
imgUrl = url+'images/game/share_b.jpg';
	wx.ready(function() {
		...
		function sharetocircle(){//发送到朋友圈
			wx.onMenuShareTimeline({
			    title: '我在${usercount}名车主中排第${sort}，获${tnum}个停车挑战名额，邀您挑战', // 分享标题
			    link: linkurl, // 分享链接
			    imgUrl: imgUrl, // 分享图标
			    success: function () { 
			        // 用户确认分享后执行的回调函数
	...
	function shareinfo(){
		...
		if(navigator.userAgent.indexOf("MicroMessenger")!=-1){
			...
			window.share.share(linkurl,'停车宝邀您完成“认证”',desc,imgUrl)
...
document.getElementById("words1").style.left=parseInt(w*0.16)+"px";
...
document.getElementById("words1").style.fontSize=parseInt(w*0.04)+"px";
