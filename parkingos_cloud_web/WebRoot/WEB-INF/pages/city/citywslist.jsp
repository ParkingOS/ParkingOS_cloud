	...
	return [{dname:"添加工作站",icon:"edit_add.png",onpress:function(Obj){
		...
		Twin({Id:"worksite_add",Title:"添加工作站",Width:550,sysfun:function(tObj){
				Tform({
					...
					formObj:tObj,
					recordid:"id",
					suburl:"cityworksite.do?action=create",
					method:"POST",
					formAttr:[{
...
function getAuthIsoperateButtons(){
	...
	bts.push({name:"编辑",fun:function(id){
		...
		Twin({Id:"worksite_edit_"+id,Title:"编辑",Width:550,sysfunI:id,sysfun:function(id,tObj){
				Tform({
					...
					suburl:"cityworksite.do?action=edit&id="+id,
					method:"POST",
					formAttr:[{
	...
	bts.push({name:"删除",fun:function(id){
		var id_this = id ;
		Tconfirm({Title:"确认删除吗",Content:"确认删除吗",OKFn:function(){T.A.sendData("cityworksite.do?action=delete","post","selids="+id_this,
