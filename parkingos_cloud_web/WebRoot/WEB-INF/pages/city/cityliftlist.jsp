...
var _mediaField = [
		...
		{fieldcnname:"通道",fieldname:"pass_id",fieldvalue:'',inputtype:"cselect",noList:[],action:"",twidth:"160" ,height:"",issort:false,
			process:function(value,pid){
				return setcname(value,pid,'pass_id');
			}},
		{fieldcnname:"抬杆原因",fieldname:"reason",fieldvalue:'',defaultValue:'',inputtype:"select",noList:[{"value_no":-1,"value_name":"全部"},{"value_no":0,"value_name":"进场无订单"},{"value_no":1,"value_name":"出场未找到订单"},{"value_no":2,"value_name":"订单异常"}], twidth:"100" ,height:"",issort:false},
