...
var _mediaField = [
		...
		{fieldcnname:"支付方式",fieldname:"pay_type",fieldvalue:'',inputtype:"select",noList:paytypes ,twidth:"80" ,height:"",issort:false},
		...
		{fieldcnname:"订单金额",fieldname:"total",fieldvalue:'',inputtype:"number",twidth:"100", height:"",issort:false,issort:true},
		...
		{fieldcnname:"状态",fieldname:"state",fieldvalue:'',inputtype:"select",noList: states,twidth:"100" ,height:"",issort:false,shide:true},
...
function searchdata(){
	...
	_orderT.C({
		...
		extparam:"&action=query&btime="+btime+"&etime="+etime+"&uid="+collector+"&comid_start="+comid+"&groupid_start="+groupid
	});
