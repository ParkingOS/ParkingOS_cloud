...
<script type="text/javascript" src="js/anlysis/mobilepayanlysis.js"></script>
...
<!--顶部开始-->
<div class="top">
<ul class="title"><li class="parentmenu">${pname }&raquo; 车场交易趋势分析 &raquo; </li>
</ul>
<ul class="search">
<span id="seconddateinput" class="search_text">
日期：<input  class="Wdate" onclick="WdatePicker({dateFmt:'yyyy-MM-dd',startDate:'%y-%M-01',alwaysUseStartDate:true})" type="text" name="endDateSelect" id="btime" align="absmiddle" readonly   />
...
<!--工具栏开始-->
<div class="tooles">
<span id="tips" class="count_tips">&nbsp;&nbsp;以天为单位统计数据</span>
