...
<div class="search">
        <div class="qiehua">
        <a  href="berthtimeanlysis.do"  id="table">列表</a>
        <a href="" id="icon" >图表</a>
        </div>
...
function initCharData(operate) {
	...
	ylist = [];
	  ...
	  if(operate==''){
	      ...
	      data_info=eval(T.A.sendData("berthtimeanlysis.do?action=echarts&operate=1&btime="+btime));
	  }
      ...
      for(var i=0;i<data_info.length;i++)
      {
        ylist.push(data_info[i].percent);
      }
}
