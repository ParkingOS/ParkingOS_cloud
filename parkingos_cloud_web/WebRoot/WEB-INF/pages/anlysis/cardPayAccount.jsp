...
var seltype="${seltype}";
var from="${from}";
var type = [{"value_no":-1,"value_name":"全部"},
            {"value_no":1,"value_name":"收入"},{"value_no":0,"value_name":"支出"}];
var charge_type = [{"value_no":-1,"value_name":"全部"},{"value_no":4,"value_name":"预付超额退款"}];
var consume_type = [{"value_no":-1,"value_name":"全部"},{"value_no":0,"value_name":"停车费"},
                   {"value_no":1,"value_name":"预付停车费 "},{"value_no":2,"value_name":"预付不足补缴"}
...
var _mediaField = [
		...
		{fieldcnname:"支出方式",fieldname:"charge_type",fieldvalue:'',inputtype:"select", noList:charge_type,twidth:"100" ,height:"",issort:false},
		{fieldcnname:"收入方式",fieldname:"consume_type",fieldvalue:'',inputtype:"select", noList:consume_type,twidth:"100" ,height:"",issort:false},
