...
public class CityAccountManageAction extends Action {
	@Autowired
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form,
		...
		if(action.equals("")){
			...
			String sql = "select a.*,w.state from city_account_tb a left join withdrawer_tb w on a.withdraw_id=w.id where a.cityid=? " ;
			String countSql = "select count(a.*) from city_account_tb a left join withdrawer_tb w on a.withdraw_id=w.id where a.cityid=? " ;
			...
			SqlInfo sqlInfo = RequestUtil.customSearch(request,"city_account_tb", "a", new String[]{"state"});
