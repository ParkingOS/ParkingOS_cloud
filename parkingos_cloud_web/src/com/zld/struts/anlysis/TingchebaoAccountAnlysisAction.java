...
public class TingchebaoAccountAnlysisAction extends Action {
	@Autowired
	...
	public ActionForward execute(ActionMapping mapping,ActionForm form,HttpServletRequest request,HttpServletResponse response) throws Exception{
		...
		if(action.equals("")){
			...
			String sql = "select * from tingchebao_account_tb ";
			String countSql = "select count(ID) as count,sum(amount) as total from tingchebao_account_tb " ;
