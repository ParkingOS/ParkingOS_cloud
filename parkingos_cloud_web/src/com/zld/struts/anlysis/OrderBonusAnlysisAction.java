...
public class OrderBonusAnlysisAction extends Action {
	@Autowired
	...
	public ActionForward execute(ActionMapping mapping,ActionForm form,HttpServletRequest request,HttpServletResponse response) throws Exception{
		...
		if(action.equals("")){
			...
			String sql = "select * from order_ticket_detail_tb ";
			String countSql = "select count(ID) as count,sum(amount) as total from order_ticket_detail_tb " ;
