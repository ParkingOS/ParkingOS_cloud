...
public class ReserveOrderAction extends Action{
	...
	private Logger logger = Logger.getLogger(ReserveOrderAction.class);
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form,
		...
		if(action.equals("")){
			...
			String sql = "select * from order_reserve_tb where ";
			String countSql = "select count(*) from order_reserve_tb where " ;
			Integer pageNum = RequestUtil.getInteger(request, "page", 1);
			Integer pageSize = RequestUtil.getInteger(request, "rp", 20);
			String fieldsstr = RequestUtil.processParams(request, "fieldsstr");
			SqlInfo sqlInfo = RequestUtil.customSearch(request,"order_reserve_tb");
			List list = null;
			Long count = 0L;
