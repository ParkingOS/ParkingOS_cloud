 ...
 *
 */
public class CarNumberTypeAction extends Action{
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form,
		...
		if(action.equals("")){
			...
			String sql = "select * from car_number_type_tb where comid=?  ";
			...
			String sql = "select * from car_number_type_tb where comid=?  ";
			String countSql = "select count(*) from car_number_type_tb where  comid=?  " ;
