...
# ParkingOS_Cloud
<h1>ParkingOS_Cloud V2.0版更新</h1></br>
1、商户优惠券管理页面增加流水详情页；</br>
2、在原有上下班对账的基础上新加了上下班汇总页；</br>
3、在原有云平台日志页基础上新增了本地收费系统日志展示；</br>
4、黑名单管理功能的强化；</br>
5、月卡续费模块优化了月卡流水记录的显示；</br>
6、新加了中控室管理页面，能快速帮停车场以及集团管理者搭建出一个中控室，实现远程监控、远程对讲、远程抬杆和远程车场事务处理比如车牌模糊匹配等功能</br>
7、后台项目修改了统计分析BUG</br>
