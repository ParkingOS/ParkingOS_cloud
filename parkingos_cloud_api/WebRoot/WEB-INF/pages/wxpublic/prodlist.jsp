...
<script src="js/wxpublic/prodlist.js?v=60"></script>
<style type="text/css">
#scroller .li1 {
    padding:0 10px;
    height:85px;
...
<div id="header">
	...
	<div id="wrapper" style="margin-top:0px;">
		<div id="scroller">
			...
			<!-- <li class="li3"><a href="" class="a2"><div class="first"><span class="com_cname">中关村创业大厦停车场</span></div></a><div class="border">11.7km</div></li>
			<li class="li1"><img class="img2" src="" /><a href="http://www.baidu.com" class="a1"><div class="cname">全天包月</div><div class="distance">120元（剩余：123）</div></a><div class="buy">已购</div></li>
			<li class="li2"><a href="" class="a2"><div class="price"><span class="first_price">时</span><span class="first_cname">可用时间：0:00 - 24:00</span><span class="sel_fee">抢购</span></div></a></li>
			<li class="li1"><img class="img2" src="" /><a href="http://www.baidu.com" class="a1"><div class="cname">全天包月</div><div class="distance">120元（剩余：123）</div></a><div class="buy">已购</div></li>
			<li class="li2"><a href="" class="a2"><div class="price"><span class="first_price">时</span><span class="first_cname">可用时间：0:00 - 24:00</span><span class="sel_fee">抢购</span></div></a></li>
			 -->
			</ul>
...
//				alert('您的位置：' + r.point.lng + ',' + r.point.lat);
				getparks(r.point.lat,r.point.lng,"${mobile}","${openid}");
			} else {
				alert("请允许获取您的地理位置！");
			}
		}, {
	...
	function setPlace(keyword){
		...
		localSearch.setSearchCompleteCallback(function (searchResult) {
				...
				getparks(poi.lat,poi.lng,"${mobile}","${openid}");
			});
