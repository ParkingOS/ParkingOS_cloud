	...
	<div id="scroller">
		<ul id="thelist">
			<li style="margin-top:32px;">
				<div class="company_name"><span>车位编号</span><input type="text" disabled="true" name="fee" class="carnumber" value="${spaceid}" /></div>
			</li>
			<input type="text" name="openid" class="hide" value="${openid}">
			<input type="text" name="codeid" class="hide" value="${codeid}">
			<input type="text" name="uid" class="hide" value="386572">
...
<div class="used noorder hide">该车位（编号：${spaceid}）已被占用</div>
<div id="footer"></div>
<script type="text/javascript">
if("${state}" == "2"){
