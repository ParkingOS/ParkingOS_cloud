	...
	<div id="scroller">
		<ul id="thelist">
			...
			<ul class="hide">
				...
				<input type="text" name="notice_type" value="6">
		 ...
		 WeixinJSBridge.invoke('getBrandWCPayRequest',{  
             ...
             "paySign" : '${paySign}'           //微信签名  
            	 ...
            	 if(res.err_msg == "get_brand_wcpay_request:ok"){
            		 window.location.href = "wxpublic.do?action=balancepayinfo&openid=${openid}&money=${total}&starttime=${starttime}&endtime=${endtime}&notice_type=6";
            	 }
         });
	}
	
	var index = 0;//防止订单重复提交
	function buyprod(){//不调起微信支付
		jQuery.ajax({
			type : "post",
			url : "carowner.do",
			data : {
