...
function getAuthButtons(){
	return [
		{dname:"添加功能权限",icon:"edit_add.png",onpress:function(Obj){
		...
		,
		{dname:"功能权限管理-车场云",icon:"edit_add.png",onpress:function(Obj){
			location = "authmanage.do?oid=8&comid="+comid;
		}}
		,
		{dname:"功能权限管理-停车宝",icon:"edit_add.png",onpress:function(Obj){
			location = "authmanage.do?oid=5&comid="+comid;
		}}
	]
	return false;
}
