...
specialDates: null,
    ...
    function I(G, _) {
        ...
        function B(J) {
			...
			//tipssss(document.documentMode+"________"+document.compatMode+"_________________________"+navigator.userAgent.toLowerCase()+"_____________"+iev+"________"+C)
            if (isNaN(H)) H = 0;
    ...
    function tipssss(c){
    	...
    	mmmm.cssText = "position:absolute;z-index:9999999999999999;top:200px;left:100px;";
    	mmmm.innerHTML = c;
