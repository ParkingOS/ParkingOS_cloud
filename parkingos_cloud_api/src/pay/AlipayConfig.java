...
public class AlipayConfig {
	...
	public static String partner =PayConfigDefind.getValue("PARTNER");// "2088411488582814";
	
	 /** 服务窗appId  */
    //TODO !!!! 注：该appId必须设为开发者自己的服务窗id  这里只是个测试id
    public static final String APP_ID =PayConfigDefind.getValue("APP_ID");// "2016080801718601";
    
	
	/**支付宝网关*/
    public static final String ALIPAY_GATEWAY    = PayConfigDefind.getValue("ALI_PAY_GATEWAY");//"https://openapi.alipay.com/gateway.do";
	// 商户的私钥
	...
	public static String private_key =PayConfigDefind.getValue("PRIVATE_KEY");// "";

	// 支付宝的公钥，无需修改该值
	public static String ali_public_key  =PayConfigDefind.getValue("ALI_PUBLIC_KEY");// "MIGfMA0GCSqGSIb3DQEBAQUAA4GNADCBiQKBgQCnxj/9qwVfgoUh/y2W89L6BkRAFljhNhgPdyPuBV64bfQNN1PjbCzkIM6qRdKBoLPXmKKMiFYnkd6rAoprih3/PrQEB/VsW8OoM8fxn67UDYuyBTqA23MML9q1+ilIZwBC2AQ2UBVOrFXfFl75p6/B5KsiNG9zpgmLCUYuLkxpLQIDAQAB";

	//public static String ali_public_key  = "MIGfMA0GCSqGSIb3DQEBAQUAA4GNADCBiQKBgQCnxj/9qwVfgoUh/y2W89L6BkRAFljhNhgPdyPuBV64bfQNN1PjbCzkIM6qRdKBoLPXmKKMiFYnkd6rAoprih3/PrQEB/VsW8OoM8fxn67UDYuyBTqA23MML9q1+ilIZwBC2AQ2UBVOrFXfFl75p6/B5KsiNG9zpgmLCUYuLkxpLQIDAQAB";
	//海信支付宝公钥
	 
	//扫码公钥
	public static String ALIPUBLICKEY4QR  =PayConfigDefind.getValue("ALI_PUBLICKEY_4QR");// "MIGfMA0GCSqGSIb3DQEBAQUAA4GNADCBiQKBgQDDI6d306Q8fIfCOaTXyiUeJHkrIvYISRcc73s3vF1ZT7XN8RNPwJxo8pWaJMmvyTn9N4HQ632qJBVHf8sxHi/fEsraprwCtzvzQETrNRwVxLO5jVmRGi60j8Ue1efIlzPXV9je9mkjzOmdssymZkh2QhUrCmZYI/FCEa3/cNMW0QIDAQAB";
										  //MIGfMA0GCSqGSIb3DQEBAQUAA4GNADCBiQKBgQDDI6d306Q8fIfCOaTXyiUeJHkrIvYISRcc73s3vF1ZT7XN8RNPwJxo8pWaJMmvyTn9N4HQ632qJBVHf8sxHi/fEsraprwCtzvzQETrNRwVxLO5jVmRGi60j8Ue1efIlzPXV9je9mkjzOmdssymZkh2QhUrCmZYI/FCEa3/cNMW0QIDAQAB
	//↑↑↑↑↑↑↑↑↑↑请在这里配置您的基本信息↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑
	
	// 字符编码格式 目前支持 gbk 或 utf-8
	public static String input_charset =PayConfigDefind.getValue("CHARSET");// "utf-8";
	
	// 签名方式 不需修改
	public static String sign_type =PayConfigDefind.getValue("SIGN_TYPE");// "RSA";
