...
public class WorkRecord implements Serializable {
	...
	public String toString() {
		return "WorkRecord [id=" + id + ", start_time=" + start_time
				+ ", end_time=" + end_time + ", worksite_id=" + worksite_id
				+ ", uid=" + uid + ", berthsec_id=" + berthsec_id
				+ ", device_code=" + device_code + ", state=" + state
				+ ", history_money=" + history_money + ", out_log=" + out_log
				+ "]";
	}
