...
//		String url = "https://s.bolink.club/unionapi/order/updateorder";
		...
		try {
			...
			String sign =StringUtils.MD5(linkParams+"key=WWDD6EFE78E11111","utf-8").toUpperCase();
...
//		String url = "https://s.bolink.club/unionapi/order/addorder";
    ...
    private static void updateuser(){
		...
		try {
			String linkParams = StringUtils.createLinkString(paramMap,0);
			System.err.println(linkParams);
			String sign =StringUtils.MD5(linkParams+"key=WWDD6EFE78E1E9F8","utf-8").toUpperCase();
			paramMap.put("sign", sign);
			String param = StringUtils.createJson(paramMap);
			ret = HttpsProxy.doPost(url, param, "utf-8", 20000, 20000);
		} catch (Exception e) {
...
//		String url = "https://123.59.42.34/unionapi/user/adduser";
		...
		try {
			String linkParams = StringUtils.createLinkString(paramMap,0);
			System.err.println(linkParams);
			String sign =StringUtils.MD5(linkParams+"key=EA2D90FEEF1E9F8E","utf-8").toUpperCase();
			paramMap.put("sign", sign);
			String param = StringUtils.createJson(paramMap);
			ret = HttpsProxy.doPost(url, param, "utf-8", 20000, 20000);
		} catch (Exception e) {
