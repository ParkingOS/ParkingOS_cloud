...
@Service
public class P4ReadService {
	@Autowired
	private P4ReadDao userDao;
	Logger logger = Logger.getLogger(P4ReadService.class);

	public List<Map<String, Object>> getAll(String sql,Object[] values ){
		List<Map<String, Object>> result = userDao.getAll(sql, values);
		return result;
	}
