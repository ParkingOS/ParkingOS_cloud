...
.first{
	background-image: url(${pageContext.request.contextPath}/resources/images/wxpublic/first_ticket.png);
...
<body>
	...
	<section>
		<div class="success">
			<div class="tips">
			    <img   class="icon-area" id="imagtitle" src="${pageContext.request.contextPath}/resources/images/wxpublic/error.png" />
				<br/><div class="tips-info epay "><span style="font-weight:bold;font-size:16px;">${errmsg}</span></div>
			</div>
		</div>
	</section>
</body>
...
<script type="text/javascript">
    ...
    if('${title_message}'!=''){
        getObj('_title').innerHTML='${title_message}';
	}
