...
<link rel="stylesheet" href="${pageContext.request.contextPath}/resources/css/weui-0.4.3.css">
<link rel="stylesheet" href="${pageContext.request.contextPath}/resources/css/jquery-weui0.8.3.css">
<script src="${pageContext.request.contextPath}/resources/js/jquery.js"></script>
<script src="${pageContext.request.contextPath}/resources/js/jquery-weui0.8.3.js"></script>
...
$(function () { 
	$("#getcode").bind("click", function () { 
		...
		jQuery.ajax({
			type:"post",
			url:"sendcode.do",
			data:{'mobile':mobile,'media':'11','openid':'${openid}'},
		    async:false,
		    success:function(result){
				if(result == "1"){
...
<div style="width:99%;">
	...
	<div style="margin-top: 10px;">
		<form action="${pageContext.request.contextPath}/lockcar" method="post" id="carownerform">
			...
			<input name="lock_status" type="text" style="display:none" value="${lock_status}"></input>
			<input name="oid" type="text" style="display:none" value="${oid}"></input>
			...
			<div style="margin-left:2.5%;margin-top:15px;font-size:12px;margin-bottom:8px"></div>
