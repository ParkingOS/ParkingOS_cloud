		...
		<mt-tab-container-item >
			...
			<div align="center" style="padding-top:15px">
				<div style="padding:4px;height:45px;padding-top:8px;border-radius:4px;background:white;">
					<form method="post" role="form" action="${pageContext.request.contextPath}/querymonth" id="checkform">
			...
			<div style="margin-top:18px" align="center">
				<mt-button type="primary" style="width:45%;margin:0px;font-size: 17px" @click="confirm('1')">临停缴费</mt-button>
				<mt-button type="primary" style="width:30%;margin:0px;font-size: 17px;margin-left: 15px" @click="confirm('0')">月卡续费</mt-button>
			</div>
		</mt-tab-container-item>
	</mt-tab-container>
        ...
        methods: {
            ...
            confirm:function(type){
                ...
                if(submitable){
                    ...
                    this.uploadcnum(carnumber,type)
                }

            },
            uploadcnum:function(carnumber,type){
