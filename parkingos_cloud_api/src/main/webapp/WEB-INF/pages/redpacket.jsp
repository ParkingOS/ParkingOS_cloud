...
<script type="text/javascript">
    ...
    if(type=='0'){
        ...
        document.getElementById("noticetitle").innerHTML="<font color='red'>红包找零失败</font>";
    }
    if(type=='1'){
        document.getElementById("image").setAttribute("class","icon-area error-icon");
        document.getElementById("noticetitle").innerHTML="<font color='red'>红包找零失败,请不要多个人同时领取</font>";
    }
    if(type=='2'){
        document.getElementById("image").setAttribute("class","icon-area error-icon");
