...
public class UserInfoTb {
    ...
    private Integer collectorPics;

    private Long collectorAuditor;
    ...
    public Integer getCollectorPics() {
        return collectorPics;
    }

    public void setCollectorPics(Integer collectorPics) {
        this.collectorPics = collectorPics;
    }

    public Long getCollectorAuditor() {
        return collectorAuditor;
    }

    public void setCollectorAuditor(Long collectorAuditor) {
        this.collectorAuditor = collectorAuditor;
    }
    ...
    public void setHxPass(String hxPass) {
        this.hxPass = hxPass == null ? null : hxPass.trim();
    }
